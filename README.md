...
```
& "$env:LOCALAPPDATA\Microsoft\WinGet\Packages\astral-sh.uv_Microsoft.Winget.Source_8wekyb3d8bbwe\uv.exe" run uvicorn homespace_ai.main:app --app-dir src --host 0.0.0.0 --port 8084 --reload
```
